...
class SunmiPrinter {
  ...
  ///*setFontItalic*
  ///
  ///This method will set Italic font
  static Future<void> setFontItalic(bool isItalic) async {
    Map<String, dynamic> arguments = <String, dynamic>{"isItalic": isItalic};
    await _channel.invokeMethod("SET_FONT_ITALIC", arguments);
  }
